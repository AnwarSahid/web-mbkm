<x-app-layout>
    ...
    <form>
        <div class="grid gap-6 mb-6 lg:grid-cols-2">
            ...
            <div>
                <label for="accreditation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
            ...
            <div>
                ...
                <select id="fakulty" name="fakulty"
                    class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            ...
            <div>
                <label for="study_level" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jenjang
                    Studi</label>
